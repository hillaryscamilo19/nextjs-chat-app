    ...
    try {
      ...
      if (input) {
        ...
        toast({
          ...
          description:
            "El texto está seleccionado. Usa Ctrl+C (o Cmd+C) para copiarlo",
        });
      } else {
        toast({
    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-gray-600">
          Genera un enlace para que otros puedan chatear contigo directamente
        </p>
      </CardHeader>
        ...
        {inviteLink && (
          <div className="space-y-3">
            ...
            <div className="text-xs text-gray-500 space-y-1">
              <p>
                💡 <strong>Tip:</strong> Haz clic en el campo de texto para
                seleccionarlo completamente
              </p>
              <p>⏰ El enlace expira en 24 horas y permite hasta 10 usuarios</p>
              <p>
                🔗 Comparte este enlace por WhatsApp, email o cualquier medio
              </p>
            </div>
              ...
              <Button
                ...
                onClick={() => {
                  const whatsappUrl = `https://wa.me/?text=${encodeURIComponent(
                    `¡Hola! ${
                      currentUser?.name || "Alguien"
                    } te invita a chatear. Únete aquí: ${inviteLink}`
                  )}`;
